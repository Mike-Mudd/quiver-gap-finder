...
| `waist_width_mm` | Underfoot width at the reference length. Varies least across lengths of the ones below, but still confirm at the reference length, not just "the model's nominal width" from the name. |
